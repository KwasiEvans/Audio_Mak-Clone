...
$music->min_song_price = (float)$db->rawQuery('SELECT MIN('.T_SONG_PRICE.'.price) AS MinPrice FROM '.T_SONG_PRICE.' WHERE '.T_SONG_PRICE.'.price > 0')[0]->MinPrice;
